...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "./weights/swin_base_patch4_window7_224.pth")



if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--model_name', type=str, default='swin_base_patch4_window7_224', choices=list(MODEL_DICT.keys()))
    ...
    parser.add_argument('--weights', type=str, default='./model/swin_base_patch4_window7_224.pth',
