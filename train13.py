...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "./weights/swin_large_patch4_window7_224_in22k.pth")



if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--model_name', type=str, default='swin_large_patch4_window7_224_in22k', choices=list(MODEL_DICT.keys()))
    ...
    parser.add_argument('--weights', type=str, default='./model/swin_large_patch4_window7_224_22k.pth',
