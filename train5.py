...
MODEL_DICT = {
    ...
    "swin_tiny_patch4_window7_224_22kto1k_finetune": swin_tiny_patch4_window7_224_22kto1k_finetune,
    "swin_small_patch4_window7_224_22kto1k_finetune": swin_small_patch4_window7_224_22kto1k_finetune,
    "swin_base_patch4_window7_224_22kto1k_finetune": swin_base_patch4_window7_224_22kto1k_finetune,
    "swin_base_patch4_window12_384_22kto1k_finetune": swin_base_patch4_window12_384_22kto1k_finetune,
    "swin_large_patch4_window7_224_22kto1k_finetune": swin_large_patch4_window7_224_22kto1k_finetune,
    "swin_base_patch4_window12_384_22kto1k_finetune": swin_base_patch4_window12_384_22kto1k_finetune,
    "swin_large_patch4_window12_384_22kto1k_finetune": swin_large_patch4_window12_384_22kto1k_finetune,
...
def main(args):
    ...
    model = create_model(args.model_name, num_classes=args.num_classes).to(device)
    ...
    for epoch in range(args.epochs):
        ...
        # torch.save(model.state_dict(), "./weights/swin_tiny_patch4_window7_224_model-{}.pth".format(epoch))
        torch.save(model.state_dict(), "./weights/swin_small_patch4_window7_224_22kto1k_finetune.pth")



if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--model_name', type=str, default='swin_small_patch4_window7_224_22kto1k_finetune', choices=list(MODEL_DICT.keys()))
    ...
    parser.add_argument('--data-path', type=str,
                        default="/home/data/wenlongxin/computer_techology/deep-learning-for-image-processing-master/data_set/flower_data/flower_photos")

    # 预训练权重路径，如果不想载入就设置为空字符
    parser.add_argument('--weights', type=str, default='./model/swin_small_patch4_window7_224_22kto1k_finetune.pth',
